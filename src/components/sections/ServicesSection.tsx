  ...
  return (
    <section id="servicos" className="py-20 lg:py-32 bg-background border-t border-border/20">
      <Container>
        ...
        {/* Services Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:gap-6 mb-16">
        ...
        <div className="flex justify-center">
          <Button 
            variant="outline" 
            href="https://wa.me/5581983066353?text=Ol%C3%A1%21%20Gostaria%20de%20saber%20mais%20sobre%20todos%20os%20servi%C3%A7os%20da%20barbearia."
            className="w-full md:w-auto text-xs tracking-[0.2em]"
            target="_blank"
