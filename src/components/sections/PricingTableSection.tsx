...
export function PricingTableSection() {
  return (
    <section id="precos" className="py-20 lg:py-32 bg-[#008DD5] lg:bg-background border-t border-border/20">
      <Container className="max-w-3xl">
        <div className="bg-[#4a8cd2] border-2 border-white/20 p-8 md:p-12 rounded-xl shadow-2xl relative">
